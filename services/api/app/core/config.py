...
DRAFT_GENERATION_ENABLED = os.getenv("DRAFT_GENERATION_ENABLED", "true").lower() in {"1", "true", "yes"}
DRAFT_GENERATION_CRON = _clean_env_text("DRAFT_GENERATION_CRON", "0 9 * * *")
...
AUTH_SESSION_COOKIE_NAME = _clean_env_text("AUTH_SESSION_COOKIE_NAME", "plx_session")
AUTH_SESSION_DURATION_DAYS = int(os.getenv("AUTH_SESSION_DURATION_DAYS", "30"))
