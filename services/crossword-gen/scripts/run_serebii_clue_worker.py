...
DEFAULT_PROVIDER_CACHE_DIR = ROOT_DIR / "data" / "crossword_provider_agents" / "serebii"


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Generate the next Serebii-backed crossword clue candidate.")
...
def main() -> None:
    ...
    if result is None:
        ...
        return
    print(f"{result['answerKey']} {result['status']} {result.get('provider', 'serebii')}")
